...
CREATE TABLE IF NOT EXISTS `glpi_plugin_formcreator_entityconfigs` (
  ...
  `is_reservation_visible`      int(11) NOT NULL DEFAULT '-2',
  `is_faq_visible`              int(11) NOT NULL DEFAULT '-2',
  `is_categorie_visible`        int(11) NOT NULL DEFAULT '-2',
  `is_sort_visible`             int(11) NOT NULL DEFAULT '-2',
