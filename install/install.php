...
class PluginFormcreatorInstall {
   ...
   protected function configureExistingEntities() {
      ...
      $query = "INSERT INTO glpi_plugin_formcreator_entityconfigs
                  (entities_id, replace_helpdesk, default_form_list_mode, sort_order, is_kb_separated, is_search_visible, is_dashboard_visible, is_header_visible, is_reservation_visible, is_faq_visible, is_categorie_visible, is_sort_visible, is_search_issue_visible)
               SELECT ent.id,
                  IF(ent.id = 0, 0, -2),
                  IF(ent.id = 0, 0, -2),
                  IF(ent.id = 0, 0, -2),
